...
const DynamicStar = ({setReviewCount}) => {
    ...
    const [ratings, setRatings] = useState ([1,2,3,4,5,2.5,5,3,5])
  ...
  return (
    <div className='DynamicStar'>
     <Rating name="half-rating-read" defaultValue={(accumulator/ratingLength).toPrecision(2)} precision={0.1} readOnly />
